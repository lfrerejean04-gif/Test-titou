...
const NOTIONS = [
  {
    ...
    emoji: "🧠",
    couleur: "#7C3AED",
    definition: "La conscience désigne le fait d'avoir des états mentaux, de percevoir le monde et de se percevoir soi-même. On distingue la conscience immédiate (spontanée, tournée vers le monde) et la conscience réfléchie (retour sur soi, connaissance de soi).",
    distinctions: [
      { terme: "Conscience immédiate", def: "Présence au monde, perception directe du réel sans retour sur soi." },
      { terme: "Conscience réfléchie", def: "Capacité à se prendre soi-même pour objet de pensée (le 'je pense que je pense')." },
      { terme: "Inconscient", def: "Ensemble de processus psychiques hors du champ de la conscience (Freud)." },
    ],
    idees: [
      { titre: "La conscience comme lumière", contenu: "La conscience éclaire le monde et se distingue de la simple réaction instinctive. Elle implique une distance par rapport aux choses." },
      { titre: "Le 'Cogito' cartésien", contenu: "Descartes fait de la conscience le fondement de toute certitude : 'Je pense, donc je suis.' La conscience est incontestable car même le doute suppose un sujet qui doute." },
      { titre: "La conscience aliénée", contenu: "Marx : la conscience peut être 'fausse conscience', déformée par les conditions sociales et économiques. L'idéologie masque la réalité." },
      { titre: "L'inconscient freudien", contenu: "Freud montre que la conscience n'est pas maître dans sa propre maison. Le ça, le moi, le surmoi structurent le psychisme. Le refoulement cache nos désirs profonds." },
      { titre: "La mauvaise foi", contenu: "Sartre : refuser sa liberté en se croyant déterminé, c'est fuir la responsabilité que la conscience impose." },
    ],
    citations: [
      ...
      { auteur: "Hegel", texte: "La conscience de soi n'existe qu'en étant reconnue.", source: "Phénoménologie de l'esprit" },
    ...
    auteurs: ["Descartes", "Freud", "Sartre", "Hegel", "Marx", "Locke", "Husserl"],
  },
  {
    id: "inconscient",
    titre: "L'Inconscient",
